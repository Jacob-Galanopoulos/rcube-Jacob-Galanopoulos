...
def _validateEdges(cubeFaces = [], cubeCenterColors = []):
    ...
    #To check the edge statically, we have to map all of the cube.
    #This requires us to choose points on the cube based off which face
    #(in order of front, right, back, left, top and bottom) and to choose
    #the edge piece based off it's space on the face. I hate magic numbers 
...
def _validateCorners(cubeFaces = [], cubeCenterColors = []):
    ...
    #To check the corner statically, we have to map all of the cube.
    #This requires us to choose points on the cube based off which face
    #(in order of front, right, back, left, top and bottom) and to choose
    #the corner piece based off it's space on the face. Kinda the same as edge
